...
public class Point4f {
	...
	public Point4f PlusVector(Vector4f Additonal) { 
		Point4f output=new Point4f(this.x+Additonal.x,this.y+Additonal.y,this.z+Additonal.z,this.a+Additonal.a);
		return output;
	}  
	
	 //implement Point minus a Vector 
	public Point4f MinusVector(Vector4f Minus) { 
		 Point4f output=new Point4f(this.x-Minus.x,this.y-Minus.y,this.z-Minus.z,this.a-Minus.a);
		 return output;
	}

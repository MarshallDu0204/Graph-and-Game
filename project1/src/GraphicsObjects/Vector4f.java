...
public class Vector4f {
	...
	{ 
		...
		float z1=z-Minus.z;
		float a1=a-Minus.a;
		Vector4f output=new Vector4f(x1,y1,z1,a1);
		return output;
	}
	...
	{ 
		Point4f output = new Point4f(x+Additonal.x,y+Additonal.y,z+Additonal.z,a+Additonal.a);
		return output;
	}
	...
	{
		Vector4f Output = new Vector4f(x*scale,y*scale,z*scale,a*scale);
		return Output;
	}
	...
	{
		Vector4f Output = new Vector4f(-x,-y,-z,-a); 
		return Output;
	}
